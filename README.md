# AI Trading Agent – lokaler V12.30-Zehn-Paare-Testbot
...
`CompressionBreakout250` / V12.30 ausschließlich im Paper-/Dry-run-Modus.
...
21. V12.30 behält dies und ersetzt nur DOGEs Route durch einen kausal
ausgewählten 4h-Supertrend(20, 3) oberhalb einer steigenden EMA100.
Alle zehn Märkte
...
V12.30 ist der aktive, vorab registrierte Paper-/Dry-run-Kandidat. Sein exakter
gemeinsamer Drei-Jahres-Test endete bei 623,606 USDT aus 250 USDT, mit PF 2,3576
und 13,3897 Prozent geschlossenem Drawdown. DOGE erzielte einzeln +112,552
USDT und blieb im jüngsten Jahr sowie bei erhöhten Gebühren positiv. Frische
Paper-Evidenz steht noch aus; SOL, LTC und BCH bleiben im gemeinsamen Test
negativ und das langfristige Ziel je Coin ist noch nicht erreicht.
