"""V12.17 ten-pair research universe on the unchanged V12.15 trading logic.

This research-only challenger keeps every V12.15 signal, exit, protection and
capital rule unchanged. The only trading-universe change is that LINK/USDT,
TRX/USDT, LTC/USDT and BCH/USDT are admitted to the same broad-core Donchian
path already used by SOL/XRP/BNB/DOGE. The active V12.15 paper bot remains on
its six approved pairs until the new universe is validated.
...
class CompressionBreakout250TenPair(IStrategy):
    """V12.17: V12.15 logic with a ten-pair research universe."""
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        """Run unchanged V12.15 signals across the ten-pair research universe."""
