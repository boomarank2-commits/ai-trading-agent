    ...
    view.innerHTML = `
      ...
      <div class="tb-wrap">
        ...
        <div class="tb-panel">
          ...
          <div class="tb-info">
            <strong>Einzeltest:</strong> Der gewählte Coin startet mit einem eigenen 250-USDT-Testwallet und simuliert exakt die aktuelle V12.31-Strategie.<br><br>
            ...
            <strong>Aktive V12.31-Änderung:</strong> DOGE behält den kausal ausgewählten 4h-Supertrend(20, 3)-Wechsel oberhalb einer steigenden EMA100. BCH nutzt zusätzlich die feste V12.26-EMA30/EMA80-Route oberhalb einer steigenden EMA100 bei ADX mindestens 24. SOL behält den V12.22-ADX21-Filter; die übrigen sieben Coin-Routen bleiben gegenüber V12.22 unverändert.<br><br>
