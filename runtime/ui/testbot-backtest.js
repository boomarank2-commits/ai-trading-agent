(() => {
  ...
  function createView() {
    ...
    view.innerHTML = `
      ...
      <div class="hx-wrap">
        <h1 class="hx-title">Hixton Clean-Backtest · 10 Coins + 3×80 Portfolio</h1>
        <p class="hx-sub">Isolierter HIXTON-V1-Basistest. Keine V12.33-Entry-/Exit-Logik, keine Coin-Sonderregeln und kein Pyramiding.</p>
        <div class="hx-panel">
          <div class="hx-row">
          ...
          <div class="hx-info">
            <strong>Hixton:</strong> VIDYA 10/20 → SMA 15, ATR 200 × 2. Long beim geschlossenen Kerzen-Cross über das obere Band, Exit beim Cross unter das untere Band.<br><br>
            ...
            <strong>Forschungsregel:</strong> Ein bereits exakt getesteter Strategie-Fingerprint wird nicht noch einmal ausgeführt. Eine spätere Variante muss materiell neue Logik/Parameter besitzen.
          </div>
        </div>
