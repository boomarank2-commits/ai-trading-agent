(() => {
  ...
  function createView() {
    ...
    view.innerHTML = `
      ...
      <div class="tb-wrap">
        <h1 class="tb-title">Backtest · Zehn-Paare-Research</h1>
        <p class="tb-sub">Historische V12.17-Forschung mit exakt der V12.15-Handelslogik und zehn Binance-Spot-Märkten. Der laufende V12.15-Paperbot bleibt bis zur Validierung auf seinen sechs freigegebenen Paaren.</p>
        <div class="tb-panel">
          <div class="tb-row">
            <div class="tb-field">
              <label for="tb-pair">Prüfmodus</label>
              <select id="tb-pair">
                <option value="PORTFOLIO" selected>Gesamtportfolio · 10 Spot-Pairs</option>
                ...
                <option value="LINK/USDT">Chainlink · LINK/USDT · Research</option>
                <option value="TRX/USDT">TRON · TRX/USDT · Research</option>
                <option value="LTC/USDT">Litecoin · LTC/USDT · Research</option>
                <option value="BCH/USDT">Bitcoin Cash · BCH/USDT · Research</option>
              </select>
            </div>
            <div class="tb-field">
            ...
            <div class="tb-actions">
              ...
              <button id="tb-start-all" class="tb-button tb-button-secondary">Alle 22 Backtests</button>
            </div>
          </div>
          <div class="tb-info">
            <strong>Universum:</strong> BTC, ETH, SOL, XRP, BNB und DOGE sind der bestehende V12.15-Kern. LINK, TRX, LTC und BCH sind neue Research-Kandidaten. Sie erhalten zunächst dieselbe Broad-Core-Donchian-Logik wie SOL/XRP/BNB/DOGE; es gibt kein nachträgliches coin-spezifisches Tuning.<br><br>
            <strong>Kapitalnutzung:</strong> Der Gesamtportfolio-Test verwendet weiterhin genau ein 250-USDT-Wallet und höchstens drei Positionen zu je 80 USDT. Alle zehn Märkte konkurrieren chronologisch um dieselben drei Slots. Einzeltests mit 250 USDT sind nur Diagnose und dürfen nicht addiert werden.<br><br>
            <strong>Wichtig:</strong> Mehrere parallele Positionen im selben Coin sind noch nicht aktiv. Bis zum separaten Konzentrations-/Execution-Test gilt maximal eine Position je Paar. Die langfristige Skalierung von Stake und Slotzahl wird erst als eigener Risikovertrag geprüft und ist nicht Bestandteil dieses Backtests.<br><br>
            <strong>Dateikontrolle:</strong> Der gesperrte Backtest bindet die isolierte V12.17-Research-Strategy und Config per Hash, prüft 1m/15m/1h/4h-Candles und blockiert fremde Repo-Dateien oder Kindprozesse.<br><br>
            <strong>Alle 22 Backtests</strong> prüft das gemeinsame Portfolio und alle zehn Einzelpaare jeweils über 3 Jahre und 1 Jahr. Bereits vorhandene identische Fingerabdrücke werden übersprungen.
          </div>
        </div>
        ...
        <div id="tb-batch-results" class="tb-panel tb-results">
          <div class="tb-result-head"><h2>Alle 22 Backtests</h2><div id="tb-batch-meta" class="tb-result-meta"></div></div>
